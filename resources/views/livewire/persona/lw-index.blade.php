<div class="m-1">
  <x-header-table>
      ...
      <div class="container-fluid flex">
          <div class="m-1 flex flex-row text-right">
              <a type="button" href="{{ route('persona.create') }}"
  ...
  <x-table>
                          ...
                          <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                              <div class="flex items-center justify-center">
                                  <div class="inline-flex" role="group">
                                      ...
                                      <a href="{{ route('persona.show', $persona->per_cod) }}"
                                      ...
                                      <button type="button" wire:click='delete({{ $persona->per_cod }} )'
      ...
      <x-pagination :modelo='$personas'> </x-pagination>
  </x-table>
</div>
